...
2. [processing.py](https://py.processing.org/) Currently an issue with .py mode working (atleast on mac), you must download the following and unzip into your modes folder.  Make sure you also unzip the src folder also. [Correct Version](https://py.processing.org/3/PythonMode_3049.zip)
